...
Satom::Satom(double x, double y, double z) : Atom(x, y, z){
   ...
   this->mndoDerivedParameterD[1] =   0.9189935 * Parameters::GetInstance()->GetAngstrom2AU();    
   this->mndoDerivedParameterD[2] =   0.8328514 * Parameters::GetInstance()->GetAngstrom2AU();    
   this->mndoDerivedParameterRho[0] = 0.4733554 * Parameters::GetInstance()->GetAngstrom2AU();  
   this->mndoDerivedParameterRho[1] = 0.5544502 * Parameters::GetInstance()->GetAngstrom2AU();  
