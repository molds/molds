...
system("echo OMP_NUM_THREADS:")
system("echo $OMP_NUM_THREADS")
system("../src/MolDS.out < ch4_zindos_dirctCIS_singlet.in > temp.dat")
system("diff ch4_zindos_dirctCIS_singlet.dat temp.dat")
system("echo '\n\n'")
...
system("echo OMP_NUM_THREADS:")
system("echo $OMP_NUM_THREADS")
system("../src/MolDS.out < c2h6_zindos_dirctCIS_singlet.in > temp.dat")
system("diff c2h6_zindos_dirctCIS_singlet.dat temp.dat")
system("echo '\n\n'")
